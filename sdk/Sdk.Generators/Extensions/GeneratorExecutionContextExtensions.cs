...
namespace Microsoft.Azure.Functions.Worker.Sdk.Generators
{
    internal static class GeneratorExecutionContextExtensions
    {
        ...
        internal static bool ShouldIncludeAutoGeneratedAttributes(this GeneratorExecutionContext context)
            => context.AnalyzerConfigOptions.ShouldIncludeAutoGeneratedAttributes();

        internal static bool ShouldIncludeAutoGeneratedAttributes(this AnalyzerConfigOptionsProvider? provider)
        {
            if (provider?.GlobalOptions?.TryGetValue(
                    Constants.BuildProperties.AutoRegisterGeneratedMetadataProvider,
                    out var autoRegisterSwitch) ?? true)
            {
                return false;
            }
