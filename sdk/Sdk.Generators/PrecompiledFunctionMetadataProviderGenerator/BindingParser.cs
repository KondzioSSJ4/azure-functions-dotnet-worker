...
using Microsoft.Azure.Functions.Worker.Sdk.Generators.PrecompiledFunctionMetadataProviderGenerator.BindingGenerator.ServiceBus;
...
namespace Microsoft.Azure.Functions.Worker.Sdk.Generators.PrecompiledFunctionMetadataProviderGenerator
{
    internal sealed class BindingParser
    {
        ...
        public IReadOnlyCollection<IGenerateableBinding> Load()
        {
            ...
            var triggerBindingCount = bindings.Count(x => x.Type == BindingType.Trigger);
